    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Create Admin<small>Admin</small></h2>
                        <ul class="nav navbar-right panel_toolbox">
                            <li><a class="collapse-link" 
                                   href="<?php echo base_url ('admin'); ?>">View Admin List</a></li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-16">
                                ...
                                echo form_dropdown ('salutation', $salutation_option, set_value ('salutation'), $attributes);
                                ?>
                            </div>
                        </div> 
                        <div class="item form-group">
