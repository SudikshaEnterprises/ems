                    ...
                    <div class="x_content">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-16">
                                ...
                                $data       = ['name'        => 'year',
                                    'id'          => 'year',
                                    'value'       => set_value ('year', $ward_data->year),
                                    'class'       => 'form-control col-md-7 col-xs-12',
                                    'placeholder' => 'Year',
                                    'required'    => '',];
                                echo form_input ($data);
                                echo form_hidden ('id',$ward_data->id);
                                ?>
                            </div>
                        </div>
                         <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                echo form_dropdown ('thana_id', $thana_, set_value ('thana', $ward_data->thana_id), $attributes);
                                ?>
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                $data       = ['name'        => 'unique_id',
                                    'id'          => 'unique_id',
                                    'value'       => set_value ('unique_id', $ward_data->unique_id),
                                    'class'       => 'form-control col-md-7 col-xs-12',
                                    'placeholder' => 'Ward ID',
                                    'required'    => '',];
                                echo form_input ($data);
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                $data       = ['name'        =>  'english_name',
                                    'id'          => 'english_name',
                                    'value'       => set_value ('english_name', $ward_data->english_name),
                                    'class'       => 'form-control col-md-7 col-xs-12',
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                $data       = ['name'        =>  'hindi_name',
                                     'id'          => 'transliterateDiv',
                                    'value'       => set_value ('hindi_name', $ward_data->hindi_name),
                                    'class'       => 'form-control col-md-7 col-xs-12',
