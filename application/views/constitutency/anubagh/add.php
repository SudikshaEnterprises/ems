    ...
    <div class="">
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="col-md-3 col-sm-3 col-xs-12 pull-right  form-group top_search">
                    <a href="<?php echo base_url ('constitutency/anubagh')?>">
                        <button class="btn btn-warning" type="submit">
                        <i class="fa fa-eye"></i> anubagh Listing</button></a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Add Anugah<small>Anugah</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        <div class="item form-group">
                            <?php
                            $attributes = ['class' => 'control-label col-md-3 col-sm-3 col-xs-12',];
                            echo form_label ('Anugah ID *', 'unique_id', $attributes);
                            ?>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?php
                                $data       = ['name'        => 'unique_id',
                                    'id'          => 'unique_id',
                                    'value'       => 'ANU_' . set_value
                                        ('unique_id'),
                                    'class'       => 'form-control col-md-7 col-xs-12',
                                    'placeholder' => 'Anugah ID',
                                    'required'    => '',];
                                echo form_input ($data);
                                ?>
                            </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                if ($booth_data->num_rows () > 0)
                                {
                                    ...
                                    {
                                        $booth_[$booth_list->id] =
                                            $booth_list->unique_id;
                                    }
                                }
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                $data       = ['name'        => 'english_name',
                                    ...
                                    'class'       => 'form-control col-md-7 col-xs-12',
                                    'placeholder' => 'Anubgah English Name',
                                    'required'    => '',];
                                echo form_input ($data);
                                ?>
                            </div>
                        ...
                        <div class="item form-group">
                            <?php
                            $attributes = ['class' => 'control-label col-md-3 col-sm-3 col-xs-12',];
                            echo form_label ('Total Voters *', 'total_voters',
                                $attributes);
                            ?>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?php
             ...
             <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Upload CSV<small>anubagh</small></h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <?php
                        $attributes = ["class" => 'form-horizontal form-label-left'];
                        echo form_open_multipart ('/constitutency/anubagh/csv_upload', $attributes);
                        if (validation_errors () != '')
                        {
                            ?>
                            <div class="alert alert-danger alert-dismissible">
                        ...
                        <div class="item form-group">
                            ...
                            ?>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                Year | Unique ID | English Name | Hindi Name | Total Voters | Booth ID 
                            </div>
                        </div>
                        <div class="item form-group">
                            <?php
                            ...
                            ?>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <a href="<?php echo base_url ('downloads/anubagh.csv') ?>"  download ><button type="button" class="btn btn-info btn-md">Click to download Sample</button></a>
                            </div>
                        </div>
                        <div class="ln_solid"></div>
                        <div class="form-group">
